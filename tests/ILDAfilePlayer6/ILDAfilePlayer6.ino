 ...
 *   
 * This version tests independent setting of XYZ and RGB interpolation.
 */
#include <Audio.h>
...
void setup() 
{
  ...
  //*
  playILDA2.setInterpolationXYZ(AudioPlayILDA::INTERPOLATE); // interpolate position ...
  playILDA2.setInterpolationRGB(AudioPlayILDA::INTERPOLATE); // ... and colour when drawing
  /*/
  playILDA2.setInterpolationMethod(AudioPlayILDA::INTERPOLATE); // interpolate position ...
  //*/
...
void loop() 
{
  ...
  if (queue1.available())
  {
    ...
    if (count < 0)
    {
      digitalToggleFast(LED_BUILTIN);
      count = 1200;
      Serial.printf("CPU load %.2f%%; ",AudioProcessorUsageMax());
      ...
      switch (interpState)
      {
        default:
          playILDA2.setInterpolationXYZ(AudioPlayILDA::INTERPOLATE); // interpolate position ...
          playILDA2.setInterpolationRGB(AudioPlayILDA::INTERPOLATE); // ... and colour when drawing
          Serial.println("both interpolating");
          interpState = 0;
          break;

        case 1:
          playILDA2.setInterpolationXYZ(AudioPlayILDA::FLOOR);
          Serial.println("XYZ floor, RGB interpolating");
          break;          
        
        case 2:
          playILDA2.setInterpolationRGB(AudioPlayILDA::FLOOR);
          Serial.println("both floor");
          break;          
        
        case 3:
          playILDA2.setInterpolationXYZ(AudioPlayILDA::INTERPOLATE);
          Serial.println("XYZ interpolating, RGB floor");
          break;          
