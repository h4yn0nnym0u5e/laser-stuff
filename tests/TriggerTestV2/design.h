...
public:
    ...
    AudioOutputTDM                  tdm1;
    AudioConnection                  *patchCord[37]; // total patchCordCount:37 including array typed ones.
...
// constructor (this is called when class-object is created)
    Projector() { 
        ...
        patchCord[pci++] = new AudioConnection(X_mrMix, 0, tdm1, 10);
        patchCord[pci++] = new AudioConnection(Y_mrMix, 0, tdm1, 8);
        patchCord[pci++] = new AudioConnection(R.mult, 0, tdm1, 6);
        patchCord[pci++] = new AudioConnection(G.mult, 0, tdm1, 4);
        patchCord[pci++] = new AudioConnection(B.mult, 0, tdm1, 2);
